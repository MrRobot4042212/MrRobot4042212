# 👋 ¡Hola! Soy Diego Alfonso

<div align="center">
<h3>Senior Application Developer & Analyst</h3>
<p>Especialista en arquitecturas Full Stack y Automatización DevOps.</p>
...
## 🚀 Sobre mí
<div align="left">
Ingeniero de software con sólida experiencia en el desarrollo de aplicaciones empresariales de alto nivel. He liderado implementaciones técnicas en sectores críticos como Salud (Cigna), Logística (Geopost) y Sistemas Aéreos (Indra).

Mi enfoque combina un desarrollo Frontend robusto (Angular/React) con arquitecturas Backend escalables (Spring Boot/Python) y una fuerte cultura DevOps (CI/CD, Docker, Kubernetes).
## 💻 Tech Stack
...
![Angular](https://img.shields.io/badge/-Angular_14+-DD0031?style=flat-square&logo=angular&logoColor=white)
...
![RxJS](https://img.shields.io/badge/-RxJS_v7-B7178C?style=flat-square&logo=reactivex&logoColor=white)
...
![Karma](https://img.shields.io/badge/-Karma-429A3C?style=flat-square&logo=karma&logoColor=white)
...
![GraphQL](https://img.shields.io/badge/-Spring_GraphQL-E10098?style=flat-square&logo=graphql&logoColor=white)
...
**Spring Modules:**  
`Spring Web` • `Spring JPA` • `Spring Security` • `Spring Validation` • `Spring Mail` • `Spring WebFlux`
...
![LXC](https://img.shields.io/badge/-LXC_Containers-333333?style=flat-square&logo=linux-containers&logoColor=white)
...
**Automation:**  
`StackStorm (Python)` • `Brokers Implementation` • `API Integration with Microservices`
...
**Capabilities:**  
`Pipeline Generation & Automation` • `Continuous Integration` • `Continuous Deployment` • `Code Quality Analysis`
...
**Methodologies:**  
![Agile](https://img.shields.io/badge/-Agile/Scrum-0052CC?style=flat-square&logo=jira-software&logoColor=white)
![Jira](https://img.shields.io/badge/-Jira-0052CC?style=flat-square&logo=jira&logoColor=white)

</div>


⭐️ From [MrRobot4042212](https://github.com/MrRobot4042212)
